...
public class InfoTramitesEnosaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Inflater inflater;
        listaelementos=(ListView) findViewById(R.id.list_tramitesenosa);
        adapter = new ArrayAdapter<String>(InfoTramitesEnosaActivity.this, android.R.layout.simple_list_item_1, informacion);
