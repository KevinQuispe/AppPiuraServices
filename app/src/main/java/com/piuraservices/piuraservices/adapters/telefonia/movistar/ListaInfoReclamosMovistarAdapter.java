...
public class ListaInfoReclamosMovistarAdapter extends ArrayAdapter<InfoReclamosMovistarmodel> {
    private Context context;
    private List<InfoReclamosMovistarmodel> values;

    public ListaInfoReclamosMovistarAdapter(Context context, List<InfoReclamosMovistarmodel> values) {
