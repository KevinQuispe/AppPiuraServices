...
public class ListaInfoReferencialEpsAdapter extends ArrayAdapter<InfoTramitesEnosamodel> {
    private Context context;
    private List<InfoTramitesEnosamodel> values; //lista con retrofit en un activity

    public ListaInfoReferencialEpsAdapter(Context context, List<InfoTramitesEnosamodel> values) {
