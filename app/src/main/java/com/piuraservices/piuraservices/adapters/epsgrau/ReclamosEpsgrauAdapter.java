...
public class ReclamosEpsgrauAdapter  implements Serializable{
        @SerializedName("id")
        @Expose
        private long id;
        ...
        public ReclamosEpsgrauAdapter() {

        }

        public ReclamosEpsgrauAdapter(long id, long entidadempresa_id, String nombre, String descripcion) {
            this.id = id;
