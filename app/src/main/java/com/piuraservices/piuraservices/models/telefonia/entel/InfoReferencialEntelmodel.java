...
public class InfoReferencialEntelmodel implements Serializable {
    ...
    public InfoReferencialEntelmodel() {
    }

    public InfoReferencialEntelmodel(long id, String nombre, String direccion, String telefono, String correo, String horario, String webentidad) {
        this.id = id;
        this.nombre = nombre;
    ...
    public String toString() {
        return "InfoReferencialEntelmodel{" +
                "id=" + id +
                ", nombre='" + nombre + '\'' +
                ", direccion='" + direccion + '\'' +
                ", telefono='" + telefono + '\'' +
